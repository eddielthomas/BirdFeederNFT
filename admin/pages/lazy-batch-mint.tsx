  ...
  return (
    ...
    <div className="background min-h-screen text-white py-24 px-16">
      <div className="flex flex-wrap space-x-10 justify-center">
        <div className="space-y-8 pb-8 text-center">
          ...
          <p className="w-96">{`Deploy HyperNFT's 721A contract and use the Metadata Renderer modulet to view your contract on the blockscanner of your choice.  The HyperNFT Protocol currently supports Ethereum, Arbitrum, Optimism, Polygon, and zkSync's testnet.`}</p>
    ...
    <form onSubmit={onSubmit} className='gap-4 lg:mx-24 sm:mx-16'>
      ...
      <div className="flex flex-wrap items-center gap-12">
        ...
        {/* HyperNFT contracts support EIP 2981 */}
        <div>
